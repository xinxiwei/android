...
int register_android_iline_JNITest(JNIEnv* env)
{
    return jniRegisterNativeMethods(env, "android/iline/JNITest",
...
/* trampoline into C++ */
extern "C"
int register_android_iline_JNITest_C(JNIEnv* env)
{
    return android::register_android_iline_JNITest(env);
}
#endif
