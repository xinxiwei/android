...
set -x
cp -r device/patch/old_version/bootable/bootloader/uboot-imx/cpu/arm_cortexa8/mx6/generic.c     bootable/bootloader/uboot-imx/cpu/arm_cortexa8/mx6 
cp -r device/patch/old_version/kernel_imx/drivers/mmc/core/mmc.c      kernel_imx/drivers/mmc/core/mmc.c
cp -r device/patch/old_version/kernel_imx/drivers/mxc/thermal/thermal.c    kernel_imx/drivers/mxc/thermal/thermal.c
