...
static int invalid_num_table[NUM_SAMPLERATES][NUM_LOWER_FRE] ={
...
int get_invalid_num(  int Upper_frq  ,  int Lower_frq  )
{
    switch( Upper_frq )
    {
        case 500:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F500][0]  , Lower_frq );
            }
        case 1000:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F1000][0]  , Lower_frq );
            }
        case 2000:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F2000][0]  , Lower_frq );
            }
        case 2500:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F2500][0]  , Lower_frq );
            }
        case 4000:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F4000][0]  , Lower_frq );
            }
        case 5000:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F5000][0]  , Lower_frq );
            }
        case 10000:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F10000][0]  , Lower_frq );
            }
        case 20000:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F20000][0]  , Lower_frq );
            }
        case 40000:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F40000][0]  , Lower_frq );
            }
        default:
            {
                return Get_InvalidNum_From_Table( &invalid_num_table[FIR_F40000][0]  , Lower_frq );
