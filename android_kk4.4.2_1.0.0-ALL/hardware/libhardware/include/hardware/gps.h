...
/**
 * Name for the GPS IO Control interface.
 */
#define GPS_IO_CTRL_INTERFACE    "gps-ioctrl"
...
/** Extended interface for IO Ctrl support. */
typedef struct {
    /** set to sizeof(GpsIOCtrlInterface) */
    size_t          size;

    /**
     * This function is used to sent IO ctrl command
     */
    int (*send_io_ctrl_command)(const char* cmd);
} GpsIOCtrlInterface;
